...
TraceKit.computeStackTrace = (function computeStackTraceWrapper() {
    ...
    function findSourceByFunctionBody(func) {
        ...
        // not sure if this is really necessary, but I donÃ¢â‚¬â„¢t have a test
...
if (typeof define === 'function' && define.amd) {
    define('foundation/lib/raven/1.1.7',[],function() { return Raven; });
}
...
$.event.add = function ravenEventAdd(elem, types, handler, data, selector) {
    ...
    // If the handler we are attaching doesnÃ¢â‚¬â„¢t have the same guid as
